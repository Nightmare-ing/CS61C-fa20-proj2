...
class TestRelu(TestCase):
    ...
    def test_length_nonpositive(self):
        t = AssemblyTest(self, "relu.s")
        array0 = t.array([])
        t.input_array("a0", array0)
        t.input_scalar("a1", len(array0))
    ...
    def test_zero(self):
        ...
        t.input_scalar("a1", len(array0))
        t.call("relu")
        t.check_array(array0, [0, 0, 1, 0, 3, 0, 5])
        t.execute()
...
class TestArgmax(TestCase):
    ...
    def test_multiple_largest(self):
        t = AssemblyTest(self, "argmax.s")
        # create an array in the data section
        array0 = t.array([5, 5, 4, 5, 1])
        # load address of the array into register a0
        t.input_array("a0", array0)
        # set a1 to the length of the array
        t.input_scalar("a1", len(array0))
...
class TestDot(TestCase):
    ...
    def test_stride_nonpositive1(self):
        t = AssemblyTest(self, "dot.s")
    ...
    def test_stride_nonpositive2(self):
        t = AssemblyTest(self, "dot.s")
        array0 = t.array([1, 2, 3])
        array1 = t.array([1, 2, 3])
        t.input_array("a0", array0)
...
class TestReadMatrix(TestCase):
    ...
    def do_read_matrix(self, fail='', code=0):
        ...
        t.check_array_pointer("a0", [1, 2, 3, 4, 5, 6])
